  ...
  return (
    <main>
      <section className='min-h-screen flex justify-center items-center flex-col text-center' id="start">
        <h2 className='text-[4rem] font-extralight'>Hallo, ich bin <span className='bg-gradient-to-r from-yellow-300 via-green-200 to-orange-400 inline-block text-transparent bg-clip-text'>Mats Snorre Fischer</span></h2>
        <p className='text-[2rem] font-extralight'>Ich bin ein Fullstack Entwickler und Systemadministrator</p>
